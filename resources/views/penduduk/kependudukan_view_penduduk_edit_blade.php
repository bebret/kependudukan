...
@section('title', 'Edit Penduduk - ' . $penduduk->nama)

@section('content')
<div class="row mb-4">
    <div class="col-md-12">
        <h1><i class="fas fa-user-edit"></i> Edit Data Penduduk</h1>
        <p class="text-muted">Mengubah data: <strong>{{ $penduduk->nama }}</strong> (NIK: {{ $penduduk->nik }})</p>
    </div>
</div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('nik') is-invalid @enderror" id="nik"
                                name="nik" value="{{ old('nik', $penduduk->nik) }}" maxlength="16" required>
                            @error('nik')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('agama') is-invalid @enderror" id="agama" name="agama">
                                ...
                                <option value="Kristen" {{ old('agama', $penduduk->agama) === 'Kristen' ? 'selected' : '' }}>Kristen
                                </option>
                                <option value="Katolik" {{ old('agama', $penduduk->agama) === 'Katolik' ? 'selected' : '' }}>Katolik
                                </option>
                                ...
                                <option value="Konghucu" {{ old('agama', $penduduk->agama) === 'Konghucu' ? 'selected' : '' }}>Konghucu
                                </option>
                            </select>
                            @error('agama')
                                <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('kelurahan') is-invalid @enderror"
                                id="kelurahan" name="kelurahan" value="{{ old('kelurahan', $penduduk->kelurahan) }}" required>
                            @error('kelurahan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('kecamatan') is-invalid @enderror"
                                id="kecamatan" name="kecamatan" value="{{ old('kecamatan', $penduduk->kecamatan) }}" required>
                            @error('kecamatan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control @error('kota') is-invalid @enderror" id="kota"
                                name="kota" value="{{ old('kota', $penduduk->kota) }}" required>
                            @error('kota')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control @error('provinsi') is-invalid @enderror"
                                id="provinsi" name="provinsi" value="{{ old('provinsi', $penduduk->provinsi) }}" required>
                            @error('provinsi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control @error('kode_pos') is-invalid @enderror"
                                id="kode_pos" name="kode_pos" value="{{ old('kode_pos', $penduduk->kode_pos) }}" maxlength="5">
                            @error('kode_pos')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('status_perkawinan') is-invalid @enderror"
                                ...
                                <option value="">-- Pilih --</option>
                                <option value="Belum Kawin" {{ old('status_perkawinan', $penduduk->status_perkawinan) === 'Belum Kawin' ? 'selected' : '' }}>
                                    Belum Kawin
                                </option>
                                <option value="Kawin" {{ old('status_perkawinan', $penduduk->status_perkawinan) === 'Kawin' ? 'selected' : '' }}>Kawin
                                </option>
                                <option value="Cerai Hidup" {{ old('status_perkawinan', $penduduk->status_perkawinan) === 'Cerai Hidup' ? 'selected' : '' }}>
                                    Cerai Hidup
                                </option>
                                <option value="Cerai Mati" {{ old('status_perkawinan', $penduduk->status_perkawinan) === 'Cerai Mati' ? 'selected' : '' }}>
                                    Cerai Mati
                                </option>
                            </select>
                        ...
                        <div class="col-md-6">
                            <label for="status_hidup" class="form-label">Status Hidup <span
                                    class="text-danger">*</span></label>
                            <select class="form-select @error('status_hidup') is-invalid @enderror" id="status_hidup"
                                name="status_hidup" required>
                                <option value="Hidup" {{ old('status_hidup', $penduduk->status_hidup) === 'Hidup' ? 'selected' : '' }}>Hidup</option>
                                <option value="Mati" {{ old('status_hidup', $penduduk->status_hidup) === 'Mati' ? 'selected' : '' }}>Mati</option>
                            </select>
                            @error('status_hidup')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control @error('pendidikan') is-invalid @enderror"
                                id="pendidikan" name="pendidikan" value="{{ old('pendidikan', $penduduk->pendidikan) }}"
