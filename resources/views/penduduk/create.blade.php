...
@section('title', 'Tambah Penduduk Baru - SIPENDUK')

@push('styles')
<style>
    /* Styling Form Dark Mode */
    .form-label-custom {
...
<div class="top-header">
    <div>
        <h1><i class="fas fa-user-plus me-2 text-primary"></i> Tambah Penduduk Baru</h1>
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="nik" class="form-control form-control-dark @error('nik') is-invalid @enderror" maxlength="16" placeholder="Masukkan 16 digit NIK..." value="{{ old('nik') }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="tempat_lahir" class="form-control form-control-dark @error('tempat_lahir') is-invalid @enderror" placeholder="Contoh: Bandung" value="{{ old('tempat_lahir') }}" required>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama" class="form-control form-control-dark @error('nama') is-invalid @enderror" placeholder="Masukkan nama sesuai KTP..." value="{{ old('nama') }}" required>
                        @error('nama') <div class="invalid-feedback">{{ $message }}</div> @enderror
                    </div>

                    <div class="mb-3">
                        <label class="form-label-custom">Tanggal Lahir<span class="text-danger-custom">*</span></label>
                        <input type="date" name="tanggal_lahir" class="form-control form-control-dark @error('tanggal_lahir') is-invalid @enderror" value="{{ old('tanggal_lahir') }}" required>
                ...
                <div class="col-12">
                    <div class="mb-3">
                        ...
                        <textarea name="alamat" class="form-control form-control-dark @error('alamat') is-invalid @enderror" rows="3" placeholder="Nama jalan, nomor rumah, RT/RW..." required>{{ old('alamat') }}</textarea>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="kelurahan" class="form-control form-control-dark" value="{{ old('kelurahan') }}">
                </div>
                <div class="col-md-6">
                    <label class="form-label-custom">Kecamatan</label>
                    <input type="text" name="kecamatan" class="form-control form-control-dark" value="{{ old('kecamatan') }}">
                </div>
                <div class="col-md-4">
                    <label class="form-label-custom">Kota/Kabupaten</label>
                    <input type="text" name="kota" class="form-control form-control-dark" value="{{ old('kota') }}">
                </div>
                <div class="col-md-4">
                    <label class="form-label-custom">Provinsi</label>
                    <input type="text" name="provinsi" class="form-control form-control-dark" value="{{ old('provinsi') }}">
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="pendidikan" class="form-control form-control-dark" placeholder="Contoh: SMA / S1" value="{{ old('pendidikan') }}">
                </div>
                <div class="col-md-4">
                    <label class="form-label-custom">Pekerjaan</label>
                    <input type="text" name="pekerjaan" class="form-control form-control-dark" placeholder="Contoh: Karyawan Swasta" value="{{ old('pekerjaan') }}">
                </div>
            </div>
        </div>
